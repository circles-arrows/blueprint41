...
namespace Blueprint41.Modeller.Generation
{
    ...
    #line 1 "E:\_CirclesArrows\blueprint41\Blueprint41.Modeller\Generation\ApiDefinition.tt"
...
#line hidden
        ...
        public override string TransformText()
        {
            ...
            #line 10 "E:\_CirclesArrows\blueprint41\Blueprint41.Modeller\Generation\ApiDefinition.tt"
    ...
    foreach (var entity in Entities)
    {
		this.CurrentEntity = entity.Name;
            ...
            #line 16 "E:\_CirclesArrows\blueprint41\Blueprint41.Modeller\Generation\ApiDefinition.tt"
...
WriteInherits(entity);
            ...
            #line 17 "E:\_CirclesArrows\blueprint41\Blueprint41.Modeller\Generation\ApiDefinition.tt"
 ...
 if(entity.Abstract || entity.Inherits.Equals("Neo4jBase"))
 {
            ...
            #line 22 "E:\_CirclesArrows\blueprint41\Blueprint41.Modeller\Generation\ApiDefinition.tt"
        ...
        foreach (var primitive in entity.Primitive)
        {
            ...
            #line 28 "E:\_CirclesArrows\blueprint41\Blueprint41.Modeller\Generation\ApiDefinition.tt"
...
WriteNullable(primitive);
            ...
            #line 29 "E:\_CirclesArrows\blueprint41\Blueprint41.Modeller\Generation\ApiDefinition.tt"
        ...
        foreach (var relationship in entity.GetRelationships(RelationshipDirection.In, false))
        {
            ...
            #line 34 "E:\_CirclesArrows\blueprint41\Blueprint41.Modeller\Generation\ApiDefinition.tt"
            ...
            #line 35 "E:\_CirclesArrows\blueprint41\Blueprint41.Modeller\Generation\ApiDefinition.tt"
            ...
            #line 38 "E:\_CirclesArrows\blueprint41\Blueprint41.Modeller\Generation\ApiDefinition.tt"
		...
		foreach (var relationship in entity.GetRelationships(RelationshipDirection.Out, true))
        {
            ...
            #line 42 "E:\_CirclesArrows\blueprint41\Blueprint41.Modeller\Generation\ApiDefinition.tt"
            ...
            #line 43 "E:\_CirclesArrows\blueprint41\Blueprint41.Modeller\Generation\ApiDefinition.tt"
            ...
            #line 47 "E:\_CirclesArrows\blueprint41\Blueprint41.Modeller\Generation\ApiDefinition.tt"
        ...
        #line 50 "E:\_CirclesArrows\blueprint41\Blueprint41.Modeller\Generation\ApiDefinition.tt"
...
private void WriteInherits(Entity entity)
{
	 if(!(string.IsNullOrEmpty(entity.Inherits) || entity.Inherits.Equals("Neo4jBase")))
     {
        ...
        #line 66 "E:\_CirclesArrows\blueprint41\Blueprint41.Modeller\Generation\ApiDefinition.tt"
...
private void WriteType(Primitive primitive)
{
	 ...
	 if(primitive.Nullable == true && type != null)
        ...
        #line 75 "E:\_CirclesArrows\blueprint41\Blueprint41.Modeller\Generation\ApiDefinition.tt"
...
private void WriteNullable(Primitive primitive)
{
	...
	if(nType == null)
    {
        ...
        #line 90 "E:\_CirclesArrows\blueprint41\Blueprint41.Modeller\Generation\ApiDefinition.tt"
