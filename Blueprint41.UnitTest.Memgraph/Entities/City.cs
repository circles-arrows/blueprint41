...
namespace Datastore.Manipulation
{
    ...
    public partial class City : OGM<City, City.CityData, System.String>, IBaseEntity, ICityOriginalData
    {
        ...
        public class CityMembers
        {
            ...
            public Property Name { get; } = Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Entities["City"].Properties["Name"];
            public Property State { get; } = Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Entities["City"].Properties["State"];
            public Property Country { get; } = Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Entities["City"].Properties["Country"];
            public Property Restaurants { get; } = Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Entities["City"].Properties["Restaurants"];
            #endregion
        ...
        sealed public override Entity GetEntity()
        {
            if (entity is null)
            {
                ...
                {
                    if (entity is null)
                        entity = Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Entities["City"];
                }
            }
            return entity;
        }
