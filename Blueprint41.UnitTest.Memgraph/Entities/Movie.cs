...
namespace Datastore.Manipulation
{
    ...
    public partial class Movie : OGM<Movie, Movie.MovieData, System.String>, IBaseEntity, IMovieOriginalData
    {
        ...
        public MOVIE_CERTIFICATION GetCertificationIf(JsNotation<System.DateTime?> CreationDate = default, JsNotation<Blueprint41.UnitTest.Memgraph.DataStore.RatingComponent?> FrighteningIntense = default, JsNotation<Blueprint41.UnitTest.Memgraph.DataStore.RatingComponent?> Profanity = default, JsNotation<Blueprint41.UnitTest.Memgraph.DataStore.RatingComponent?> SexAndNudity = default, JsNotation<Blueprint41.UnitTest.Memgraph.DataStore.RatingComponent?> Substances = default, JsNotation<Blueprint41.UnitTest.Memgraph.DataStore.RatingComponent?> ViolenceGore = default)
        {
        ...
        public void SetCertification(Rating rating, JsNotation<Blueprint41.UnitTest.Memgraph.DataStore.RatingComponent?> FrighteningIntense = default, JsNotation<Blueprint41.UnitTest.Memgraph.DataStore.RatingComponent?> Profanity = default, JsNotation<Blueprint41.UnitTest.Memgraph.DataStore.RatingComponent?> SexAndNudity = default, JsNotation<Blueprint41.UnitTest.Memgraph.DataStore.RatingComponent?> Substances = default, JsNotation<Blueprint41.UnitTest.Memgraph.DataStore.RatingComponent?> ViolenceGore = default)
        {
            Dictionary<string, object> properties = new Dictionary<string, object>();
        ...
        public class MovieMembers
        {
            ...
            public Property Title { get; } = Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Entities["Movie"].Properties["Title"];
            public Property Director { get; } = Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Entities["Movie"].Properties["Director"];
            public Property Actors { get; } = Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Entities["Movie"].Properties["Actors"];
            public Property Certification { get; } = Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Entities["Movie"].Properties["Certification"];
            #endregion
        ...
        sealed public override Entity GetEntity()
        {
            if (entity is null)
            {
                ...
                {
                    if (entity is null)
                        entity = Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Entities["Movie"];
                }
            }
            return entity;
        }
