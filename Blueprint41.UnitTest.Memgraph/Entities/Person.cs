...
namespace Datastore.Manipulation
{
    ...
    public partial class Person : OGM<Person, Person.PersonData, System.String>, IBaseEntity, IPersonOriginalData
    {
        ...
        public class PersonMembers
        {
            ...
            public Property Name { get; } = Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Entities["Person"].Properties["Name"];
            public Property Restaurants { get; } = Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Entities["Person"].Properties["Restaurants"];
            public Property DirectedMovies { get; } = Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Entities["Person"].Properties["DirectedMovies"];
            public Property ActedInMovies { get; } = Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Entities["Person"].Properties["ActedInMovies"];
            public Property StreamingServiceSubscriptions { get; } = Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Entities["Person"].Properties["StreamingServiceSubscriptions"];
            public Property WatchedMovies { get; } = Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Entities["Person"].Properties["WatchedMovies"];
            public Property City { get; } = Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Entities["Person"].Properties["City"];
            #endregion
        ...
        sealed public override Entity GetEntity()
        {
            if (entity is null)
            {
                ...
                {
                    if (entity is null)
                        entity = Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Entities["Person"];
                }
            }
            return entity;
        }
