...
namespace Datastore.Manipulation
{
    ...
    public partial class Rating : OGM<Rating, Rating.RatingData, System.String>, IBaseEntity, IRatingOriginalData
    {
        ...
        public class RatingMembers
        {
            ...
            public Property Code { get; } = Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Entities["Rating"].Properties["Code"];
            public Property Name { get; } = Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Entities["Rating"].Properties["Name"];
            public Property Description { get; } = Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Entities["Rating"].Properties["Description"];
            #endregion
        ...
        sealed public override Entity GetEntity()
        {
            if (entity is null)
            {
                ...
                {
                    if (entity is null)
                        entity = Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Entities["Rating"];
                }
            }
            return entity;
        }
