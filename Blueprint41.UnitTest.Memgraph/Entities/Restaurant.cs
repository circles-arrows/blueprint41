...
namespace Datastore.Manipulation
{
    ...
    public partial class Restaurant : OGM<Restaurant, Restaurant.RestaurantData, System.String>, IBaseEntity, IRestaurantOriginalData
    {
        ...
        public class RestaurantMembers
        {
            ...
            public Property Name { get; } = Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Entities["Restaurant"].Properties["Name"];
            public Property City { get; } = Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Entities["Restaurant"].Properties["City"];
            public Property Persons { get; } = Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Entities["Restaurant"].Properties["Persons"];
            #endregion
        ...
        sealed public override Entity GetEntity()
        {
            if (entity is null)
            {
                ...
                {
                    if (entity is null)
                        entity = Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Entities["Restaurant"];
                }
            }
            return entity;
        }
