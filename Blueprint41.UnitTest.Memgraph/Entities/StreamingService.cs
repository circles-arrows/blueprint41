...
namespace Datastore.Manipulation
{
    ...
    public partial class StreamingService : OGM<StreamingService, StreamingService.StreamingServiceData, System.String>, IBaseEntity, IStreamingServiceOriginalData
    {
        ...
        public class StreamingServiceMembers
        {
            ...
            public Property Name { get; } = Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Entities["StreamingService"].Properties["Name"];
            public Property Subscribers { get; } = Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Entities["StreamingService"].Properties["Subscribers"];
            #endregion
        ...
        sealed public override Entity GetEntity()
        {
            if (entity is null)
            {
                ...
                {
                    if (entity is null)
                        entity = Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Entities["StreamingService"];
                }
            }
            return entity;
        }
