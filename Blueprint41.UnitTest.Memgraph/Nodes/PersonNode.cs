        ...
        public override IReadOnlyDictionary<string, FieldResult> AliasFields
        {
            get
            {
                if (m_AliasFields is null)
                {
                    ...
                    {
                        { "Name", new StringResult(this, "Name", Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Entities["Person"], Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Entities["Person"].Properties["Name"]) },
                        { "Uid", new StringResult(this, "Uid", Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Entities["Person"], Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Entities["BaseEntity"].Properties["Uid"]) },
                        { "LastModifiedOn", new DateTimeResult(this, "LastModifiedOn", Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Entities["Person"], Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Entities["BaseEntity"].Properties["LastModifiedOn"]) },
                    };
                }
