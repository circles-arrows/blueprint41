        ...
        public override IReadOnlyDictionary<string, FieldResult> AliasFields
        {
            get
            {
                if (m_AliasFields is null)
                {
                    ...
                    {
                        { "Code", new StringResult(this, "Code", Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Entities["Rating"], Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Entities["Rating"].Properties["Code"]) },
                        { "Name", new StringResult(this, "Name", Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Entities["Rating"], Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Entities["Rating"].Properties["Name"]) },
                        { "Description", new StringResult(this, "Description", Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Entities["Rating"], Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Entities["Rating"].Properties["Description"]) },
                        { "Uid", new StringResult(this, "Uid", Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Entities["Rating"], Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Entities["BaseEntity"].Properties["Uid"]) },
                        { "LastModifiedOn", new DateTimeResult(this, "LastModifiedOn", Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Entities["Rating"], Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Entities["BaseEntity"].Properties["LastModifiedOn"]) },
                    };
                }
