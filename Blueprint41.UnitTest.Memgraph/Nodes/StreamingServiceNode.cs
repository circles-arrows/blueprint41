...
namespace Datastore.Query
{
    ...
    public partial class StreamingServiceNode : Blueprint41.Query.Node
    {
        ...
        public FunctionalId FunctionalId
        {
            get
            {
                return m.StreamingService.Entity.FunctionalId;
            }
        }
        ...
        public override IReadOnlyDictionary<string, FieldResult> AliasFields
        {
            get
            {
                if (m_AliasFields is null)
                {
                    ...
                    {
                        { "Name", new StringResult(this, "Name", Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Entities["StreamingService"], Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Entities["StreamingService"].Properties["Name"]) },
                        { "Uid", new StringResult(this, "Uid", Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Entities["StreamingService"], Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Entities["BaseEntity"].Properties["Uid"]) },
                        { "LastModifiedOn", new DateTimeResult(this, "LastModifiedOn", Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Entities["StreamingService"], Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Entities["BaseEntity"].Properties["LastModifiedOn"]) },
                    };
                }
