...
public partial class MOVIE_CERTIFICATION_REL : RELATIONSHIP, IFromIn_MOVIE_CERTIFICATION_REL, IFromOut_MOVIE_CERTIFICATION_REL    {
    ...
    public class MOVIE_CERTIFICATION_ALIAS : AliasResult
    {
        ...
        internal MOVIE_CERTIFICATION_ALIAS(MOVIE_CERTIFICATION_REL parent)
        {
            ...
            CreationDate = new DateTimeResult(this, "CreationDate", Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Relations["MOVIE_CERTIFICATION"], Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Relations["MOVIE_CERTIFICATION"].Properties["CreationDate"]);
            FrighteningIntense = new StringResult(this, "FrighteningIntense", Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Relations["MOVIE_CERTIFICATION"], Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Relations["MOVIE_CERTIFICATION"].Properties["FrighteningIntense"]);
            ViolenceGore = new StringResult(this, "ViolenceGore", Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Relations["MOVIE_CERTIFICATION"], Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Relations["MOVIE_CERTIFICATION"].Properties["ViolenceGore"]);
            Profanity = new StringResult(this, "Profanity", Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Relations["MOVIE_CERTIFICATION"], Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Relations["MOVIE_CERTIFICATION"].Properties["Profanity"]);
            Substances = new StringResult(this, "Substances", Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Relations["MOVIE_CERTIFICATION"], Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Relations["MOVIE_CERTIFICATION"].Properties["Substances"]);
            SexAndNudity = new StringResult(this, "SexAndNudity", Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Relations["MOVIE_CERTIFICATION"], Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Relations["MOVIE_CERTIFICATION"].Properties["SexAndNudity"]);
        }

        public Assignment[] Assign(JsNotation<System.DateTime?> CreationDate = default, JsNotation<Blueprint41.UnitTest.Memgraph.DataStore.RatingComponent?> FrighteningIntense = default, JsNotation<Blueprint41.UnitTest.Memgraph.DataStore.RatingComponent?> Profanity = default, JsNotation<Blueprint41.UnitTest.Memgraph.DataStore.RatingComponent?> SexAndNudity = default, JsNotation<Blueprint41.UnitTest.Memgraph.DataStore.RatingComponent?> Substances = default, JsNotation<Blueprint41.UnitTest.Memgraph.DataStore.RatingComponent?> ViolenceGore = default)
        {
