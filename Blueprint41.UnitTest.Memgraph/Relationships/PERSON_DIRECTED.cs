...
public partial class PERSON_DIRECTED_REL : RELATIONSHIP, IFromIn_PERSON_DIRECTED_REL, IFromOut_PERSON_DIRECTED_REL    {
    ...
    public class PERSON_DIRECTED_ALIAS : AliasResult
    {
        ...
        internal PERSON_DIRECTED_ALIAS(PERSON_DIRECTED_REL parent)
        {
            ...
            CreationDate = new DateTimeResult(this, "CreationDate", Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Relations["PERSON_DIRECTED"], Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Relations["PERSON_DIRECTED"].Properties["CreationDate"]);
        }
