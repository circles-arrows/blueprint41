...
public partial class SUBSCRIBED_TO_STREAMING_SERVICE_REL : RELATIONSHIP, IFromIn_SUBSCRIBED_TO_STREAMING_SERVICE_REL, IFromOut_SUBSCRIBED_TO_STREAMING_SERVICE_REL    {
    ...
    public class SUBSCRIBED_TO_STREAMING_SERVICE_ALIAS : AliasResult
    {
        ...
        internal SUBSCRIBED_TO_STREAMING_SERVICE_ALIAS(SUBSCRIBED_TO_STREAMING_SERVICE_REL parent)
        {
            ...
            CreationDate = new DateTimeResult(this, "CreationDate", Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Relations["SUBSCRIBED_TO_STREAMING_SERVICE"], Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Relations["SUBSCRIBED_TO_STREAMING_SERVICE"].Properties["CreationDate"]);
            MonthlyFee = new NumericResult(this, "MonthlyFee", Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Relations["SUBSCRIBED_TO_STREAMING_SERVICE"], Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Relations["SUBSCRIBED_TO_STREAMING_SERVICE"].Properties["MonthlyFee"]);
            StartDate = new DateTimeResult(this, "StartDate", Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Relations["SUBSCRIBED_TO_STREAMING_SERVICE"], Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Relations["SUBSCRIBED_TO_STREAMING_SERVICE"].Properties["StartDate"]);
            EndDate = new DateTimeResult(this, "EndDate", Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Relations["SUBSCRIBED_TO_STREAMING_SERVICE"], Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Relations["SUBSCRIBED_TO_STREAMING_SERVICE"].Properties["EndDate"]);
        }
