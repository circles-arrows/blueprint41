...
public partial class WATCHED_MOVIE_REL : RELATIONSHIP, IFromIn_WATCHED_MOVIE_REL, IFromOut_WATCHED_MOVIE_REL    {
    ...
    public class WATCHED_MOVIE_ALIAS : AliasResult
    {
        ...
        internal WATCHED_MOVIE_ALIAS(WATCHED_MOVIE_REL parent)
        {
            ...
            CreationDate = new DateTimeResult(this, "CreationDate", Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Relations["WATCHED_MOVIE"], Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Relations["WATCHED_MOVIE"].Properties["CreationDate"]);
            MinutesWatched = new NumericResult(this, "MinutesWatched", Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Relations["WATCHED_MOVIE"], Blueprint41.UnitTest.Memgraph.DataStore.MockModel.Model.Relations["WATCHED_MOVIE"].Properties["MinutesWatched"]);
        }
