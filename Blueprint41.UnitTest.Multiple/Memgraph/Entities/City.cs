    ...
    public partial class City : OGM<City, City.CityData, System.String>, IBaseEntity, ICityOriginalData
    {
        ...
        protected override void ValidateSave()
        {
            ...
            if (InnerData.Uid is null)
                throw new PersistenceException(string.Format("Cannot save City with key '{0}' because the Uid cannot be null.", this.Uid?.ToString() ?? "<null>"));
        }
        ...
        public class CityMembers
        {
            ...
            public EntityProperty Name { get; } = Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Entities["City"].Properties["Name"];
            public EntityProperty State { get; } = Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Entities["City"].Properties["State"];
            public EntityProperty Country { get; } = Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Entities["City"].Properties["Country"];
            public EntityProperty Restaurants { get; } = Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Entities["City"].Properties["Restaurants"];
            #endregion
        ...
        sealed public override Entity GetEntity()
        {
            if (entity is null)
            {
                ...
                {
                    if (entity is null)
                        entity = Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Entities["City"];
                }
            }
            return entity;
        }
