...
namespace Memgraph.Datastore.Manipulation
{
    ...
    public partial class MOVIE_CERTIFICATION
    {
        private MOVIE_CERTIFICATION(string elementId, Movie @in, Rating @out, Dictionary<string, object> properties)
        {
            ...
            FrighteningIntense = (Blueprint41.UnitTest.Multiple.DataStore.RatingComponent?)PersistenceProvider.CurrentPersistenceProvider.ConvertFromStoredType(typeof(Blueprint41.UnitTest.Multiple.DataStore.RatingComponent?), properties.GetValue("FrighteningIntense"));
            ViolenceGore = (Blueprint41.UnitTest.Multiple.DataStore.RatingComponent?)PersistenceProvider.CurrentPersistenceProvider.ConvertFromStoredType(typeof(Blueprint41.UnitTest.Multiple.DataStore.RatingComponent?), properties.GetValue("ViolenceGore"));
            Profanity = (Blueprint41.UnitTest.Multiple.DataStore.RatingComponent?)PersistenceProvider.CurrentPersistenceProvider.ConvertFromStoredType(typeof(Blueprint41.UnitTest.Multiple.DataStore.RatingComponent?), properties.GetValue("Profanity"));
            Substances = (Blueprint41.UnitTest.Multiple.DataStore.RatingComponent?)PersistenceProvider.CurrentPersistenceProvider.ConvertFromStoredType(typeof(Blueprint41.UnitTest.Multiple.DataStore.RatingComponent?), properties.GetValue("Substances"));
            SexAndNudity = (Blueprint41.UnitTest.Multiple.DataStore.RatingComponent?)PersistenceProvider.CurrentPersistenceProvider.ConvertFromStoredType(typeof(Blueprint41.UnitTest.Multiple.DataStore.RatingComponent?), properties.GetValue("SexAndNudity"));
        }
        ...
        public Blueprint41.UnitTest.Multiple.DataStore.RatingComponent? FrighteningIntense { get; private set; }
        public Blueprint41.UnitTest.Multiple.DataStore.RatingComponent? ViolenceGore { get; private set; }
        public Blueprint41.UnitTest.Multiple.DataStore.RatingComponent? Profanity { get; private set; }
        public Blueprint41.UnitTest.Multiple.DataStore.RatingComponent? Substances { get; private set; }
        public Blueprint41.UnitTest.Multiple.DataStore.RatingComponent? SexAndNudity { get; private set; }

        public void Assign(JsNotation<Blueprint41.UnitTest.Multiple.DataStore.RatingComponent?> FrighteningIntense = default, JsNotation<Blueprint41.UnitTest.Multiple.DataStore.RatingComponent?> Profanity = default, JsNotation<Blueprint41.UnitTest.Multiple.DataStore.RatingComponent?> SexAndNudity = default, JsNotation<Blueprint41.UnitTest.Multiple.DataStore.RatingComponent?> Substances = default, JsNotation<Blueprint41.UnitTest.Multiple.DataStore.RatingComponent?> ViolenceGore = default)
        {
        ...
        public static List<MOVIE_CERTIFICATION> Where(JsNotation<System.DateTime?> CreationDate = default, JsNotation<Blueprint41.UnitTest.Multiple.DataStore.RatingComponent?> FrighteningIntense = default, JsNotation<Blueprint41.UnitTest.Multiple.DataStore.RatingComponent?> Profanity = default, JsNotation<Blueprint41.UnitTest.Multiple.DataStore.RatingComponent?> SexAndNudity = default, JsNotation<Blueprint41.UnitTest.Multiple.DataStore.RatingComponent?> Substances = default, JsNotation<Blueprint41.UnitTest.Multiple.DataStore.RatingComponent?> ViolenceGore = default, JsNotation<Movie> InNode = default, JsNotation<Rating> OutNode = default)
        {
        ...
        public static Relationship Relationship => ThreadSafe.LazyInit(ref _relationship, () => Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Relations["MOVIE_CERTIFICATION"]);
    ...
    {
        public static void Assign(this IEnumerable<MOVIE_CERTIFICATION> @this, JsNotation<Blueprint41.UnitTest.Multiple.DataStore.RatingComponent?> FrighteningIntense = default, JsNotation<Blueprint41.UnitTest.Multiple.DataStore.RatingComponent?> Profanity = default, JsNotation<Blueprint41.UnitTest.Multiple.DataStore.RatingComponent?> SexAndNudity = default, JsNotation<Blueprint41.UnitTest.Multiple.DataStore.RatingComponent?> Substances = default, JsNotation<Blueprint41.UnitTest.Multiple.DataStore.RatingComponent?> ViolenceGore = default)
        {
            var query = Transaction.CompiledQuery
                .Match(node.Movie.Alias(out var inAlias).In.MOVIE_CERTIFICATION.Alias(out var relAlias).Out.Rating.Alias(out var outAlias))
