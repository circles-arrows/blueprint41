...
namespace Memgraph.Datastore.Manipulation
{
    ...
    public partial class Person : OGM<Person, Person.PersonData, System.String>, IBaseEntity, IPersonOriginalData
    {
        ...
        public class PersonMembers
        {
            ...
            public EntityProperty Name { get; } = Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Entities["Person"].Properties["Name"];
            public EntityProperty Restaurants { get; } = Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Entities["Person"].Properties["Restaurants"];
            public EntityProperty DirectedMovies { get; } = Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Entities["Person"].Properties["DirectedMovies"];
            public EntityProperty ActedInMovies { get; } = Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Entities["Person"].Properties["ActedInMovies"];
            public EntityProperty StreamingServiceSubscriptions { get; } = Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Entities["Person"].Properties["StreamingServiceSubscriptions"];
            public EntityProperty WatchedMovies { get; } = Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Entities["Person"].Properties["WatchedMovies"];
            public EntityProperty City { get; } = Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Entities["Person"].Properties["City"];
            #endregion
        ...
        sealed public override Entity GetEntity()
        {
            if (entity is null)
            {
                ...
                {
                    if (entity is null)
                        entity = Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Entities["Person"];
                }
            }
            return entity;
        }
