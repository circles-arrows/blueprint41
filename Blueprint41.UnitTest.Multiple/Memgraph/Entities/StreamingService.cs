    ...
    public partial class StreamingService : OGM<StreamingService, StreamingService.StreamingServiceData, System.String>, IBaseEntity, IStreamingServiceOriginalData
    {
        ...
        protected override void ValidateSave()
        {
            ...
            if (InnerData.Uid is null)
                throw new PersistenceException(string.Format("Cannot save StreamingService with key '{0}' because the Uid cannot be null.", this.Uid?.ToString() ?? "<null>"));
        }
        ...
        public class StreamingServiceMembers
        {
            ...
            public EntityProperty Name { get; } = Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Entities["StreamingService"].Properties["Name"];
            public EntityProperty Subscribers { get; } = Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Entities["StreamingService"].Properties["Subscribers"];
            #endregion
        ...
        sealed public override Entity GetEntity()
        {
            if (entity is null)
            {
                ...
                {
                    if (entity is null)
                        entity = Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Entities["StreamingService"];
                }
            }
            return entity;
        }
