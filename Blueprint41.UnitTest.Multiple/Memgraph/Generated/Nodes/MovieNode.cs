        ...
        public override IReadOnlyDictionary<string, FieldResult> AliasFields
        {
            get
            {
                if (m_AliasFields is null)
                {
                    ...
                    {
                        { "title", new StringResult(this, "title", Blueprint41.UnitTest.Multiple.Memgraph.DataStore.MemgraphModel.Model.Entities["Movie"], Blueprint41.UnitTest.Multiple.Memgraph.DataStore.MemgraphModel.Model.Entities["Movie"].Properties["title"]) },
                        { "tagline", new StringResult(this, "tagline", Blueprint41.UnitTest.Multiple.Memgraph.DataStore.MemgraphModel.Model.Entities["Movie"], Blueprint41.UnitTest.Multiple.Memgraph.DataStore.MemgraphModel.Model.Entities["Movie"].Properties["tagline"]) },
                        { "released", new NumericResult(this, "released", Blueprint41.UnitTest.Multiple.Memgraph.DataStore.MemgraphModel.Model.Entities["Movie"], Blueprint41.UnitTest.Multiple.Memgraph.DataStore.MemgraphModel.Model.Entities["Movie"].Properties["released"]) },
                        { "Uid", new StringResult(this, "Uid", Blueprint41.UnitTest.Multiple.Memgraph.DataStore.MemgraphModel.Model.Entities["Movie"], Blueprint41.UnitTest.Multiple.Memgraph.DataStore.MemgraphModel.Model.Entities["Movie"].Properties["Uid"]) },
                    };
                }
