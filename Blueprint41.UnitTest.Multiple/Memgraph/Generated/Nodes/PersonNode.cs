        ...
        public override IReadOnlyDictionary<string, FieldResult> AliasFields
        {
            get
            {
                if (m_AliasFields is null)
                {
                    ...
                    {
                        { "name", new StringResult(this, "name", Blueprint41.UnitTest.Multiple.Memgraph.DataStore.MemgraphModel.Model.Entities["Person"], Blueprint41.UnitTest.Multiple.Memgraph.DataStore.MemgraphModel.Model.Entities["Person"].Properties["name"]) },
                        { "born", new NumericResult(this, "born", Blueprint41.UnitTest.Multiple.Memgraph.DataStore.MemgraphModel.Model.Entities["Person"], Blueprint41.UnitTest.Multiple.Memgraph.DataStore.MemgraphModel.Model.Entities["Person"].Properties["born"]) },
                        { "Uid", new StringResult(this, "Uid", Blueprint41.UnitTest.Multiple.Memgraph.DataStore.MemgraphModel.Model.Entities["Person"], Blueprint41.UnitTest.Multiple.Memgraph.DataStore.MemgraphModel.Model.Entities["Person"].Properties["Uid"]) },
                    };
                }
