...
public partial class ACTED_IN_REL : RELATIONSHIP, IFromIn_ACTED_IN_REL, IFromOut_ACTED_IN_REL    {
    ...
    public class ACTED_IN_ALIAS : AliasResult
    {
        ...
        internal ACTED_IN_ALIAS(ACTED_IN_REL parent)
        {
            ...
            CreationDate = new DateTimeResult(this, "CreationDate", Blueprint41.UnitTest.Multiple.Memgraph.DataStore.MemgraphModel.Model.Relations["ACTED_IN"], Blueprint41.UnitTest.Multiple.Memgraph.DataStore.MemgraphModel.Model.Relations["ACTED_IN"].Properties["CreationDate"]);
            roles = new StringListResult(this, "roles", Blueprint41.UnitTest.Multiple.Memgraph.DataStore.MemgraphModel.Model.Relations["ACTED_IN"], Blueprint41.UnitTest.Multiple.Memgraph.DataStore.MemgraphModel.Model.Relations["ACTED_IN"].Properties["roles"]);
        }

        public Assignment[] Assign(JsNotation<System.DateTime?> CreationDate = default, JsNotation<string[]> roles = default)
        {
            List<Assignment> assignments = new List<Assignment>();
            if (CreationDate.HasValue) assignments.Add(new Assignment(this.CreationDate, CreationDate));
            if (roles.HasValue) assignments.Add(new Assignment(this.roles, roles));

            return assignments.ToArray();
        }

        public DateTimeResult CreationDate { get; private set; } 
        public StringListResult roles { get; private set; } 
    }
}
