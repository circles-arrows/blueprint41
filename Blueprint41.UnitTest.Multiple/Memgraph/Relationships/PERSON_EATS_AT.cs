...
public partial class PERSON_EATS_AT_REL : RELATIONSHIP, IFromIn_PERSON_EATS_AT_REL, IFromOut_PERSON_EATS_AT_REL    {
    ...
    public class PERSON_EATS_AT_ALIAS : AliasResult
    {
        ...
        internal PERSON_EATS_AT_ALIAS(PERSON_EATS_AT_REL parent)
        {
            ...
            CreationDate = new DateTimeResult(this, "CreationDate", Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Relations["PERSON_EATS_AT"], Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Relations["PERSON_EATS_AT"].Properties["CreationDate"]);
        }
