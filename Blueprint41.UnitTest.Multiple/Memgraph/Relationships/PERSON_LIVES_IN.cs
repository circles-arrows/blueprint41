...
public partial class PERSON_LIVES_IN_REL : RELATIONSHIP, IFromIn_PERSON_LIVES_IN_REL, IFromOut_PERSON_LIVES_IN_REL    {
    ...
    public class PERSON_LIVES_IN_ALIAS : AliasResult
    {
        ...
        internal PERSON_LIVES_IN_ALIAS(PERSON_LIVES_IN_REL parent)
        {
            ...
            CreationDate = new DateTimeResult(this, "CreationDate", Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Relations["PERSON_LIVES_IN"], Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Relations["PERSON_LIVES_IN"].Properties["CreationDate"]);
            StartDate = new DateTimeResult(this, "StartDate", Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Relations["PERSON_LIVES_IN"], Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Relations["PERSON_LIVES_IN"].Properties["StartDate"]);
            EndDate = new DateTimeResult(this, "EndDate", Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Relations["PERSON_LIVES_IN"], Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Relations["PERSON_LIVES_IN"].Properties["EndDate"]);
            AddressLine1 = new StringResult(this, "AddressLine1", Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Relations["PERSON_LIVES_IN"], Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Relations["PERSON_LIVES_IN"].Properties["AddressLine1"]);
            AddressLine2 = new StringResult(this, "AddressLine2", Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Relations["PERSON_LIVES_IN"], Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Relations["PERSON_LIVES_IN"].Properties["AddressLine2"]);
            AddressLine3 = new StringResult(this, "AddressLine3", Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Relations["PERSON_LIVES_IN"], Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Relations["PERSON_LIVES_IN"].Properties["AddressLine3"]);
        }
