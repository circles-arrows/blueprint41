    ...
    public partial class Movie : OGM<Movie, Movie.MovieData, System.String>, IBaseEntity, IMovieOriginalData
    {
        ...
        protected override void ValidateSave()
        {
            ...
            if (InnerData.Uid is null)
                throw new PersistenceException(string.Format("Cannot save Movie with key '{0}' because the Uid cannot be null.", this.Uid?.ToString() ?? "<null>"));
        }
        ...
        public MOVIE_CERTIFICATION GetCertificationIf(JsNotation<System.DateTime?> CreationDate = default, JsNotation<Blueprint41.UnitTest.Multiple.DataStore.RatingComponent?> FrighteningIntense = default, JsNotation<Blueprint41.UnitTest.Multiple.DataStore.RatingComponent?> Profanity = default, JsNotation<Blueprint41.UnitTest.Multiple.DataStore.RatingComponent?> SexAndNudity = default, JsNotation<Blueprint41.UnitTest.Multiple.DataStore.RatingComponent?> Substances = default, JsNotation<Blueprint41.UnitTest.Multiple.DataStore.RatingComponent?> ViolenceGore = default)
        {
        ...
        public void SetCertification(Rating rating, JsNotation<Blueprint41.UnitTest.Multiple.DataStore.RatingComponent?> FrighteningIntense = default, JsNotation<Blueprint41.UnitTest.Multiple.DataStore.RatingComponent?> Profanity = default, JsNotation<Blueprint41.UnitTest.Multiple.DataStore.RatingComponent?> SexAndNudity = default, JsNotation<Blueprint41.UnitTest.Multiple.DataStore.RatingComponent?> Substances = default, JsNotation<Blueprint41.UnitTest.Multiple.DataStore.RatingComponent?> ViolenceGore = default)
        {
            Dictionary<string, object> properties = new Dictionary<string, object>();
        ...
        public class MovieMembers
        {
            ...
            public EntityProperty Title { get; } = Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Entities["Movie"].Properties["Title"];
            public EntityProperty Director { get; } = Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Entities["Movie"].Properties["Director"];
            public EntityProperty Actors { get; } = Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Entities["Movie"].Properties["Actors"];
            public EntityProperty Certification { get; } = Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Entities["Movie"].Properties["Certification"];
            #endregion
        ...
        sealed public override Entity GetEntity()
        {
            if (entity is null)
            {
                ...
                {
                    if (entity is null)
                        entity = Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Entities["Movie"];
                }
            }
            return entity;
        }
