    ...
    public partial class Restaurant : OGM<Restaurant, Restaurant.RestaurantData, System.String>, IBaseEntity, IRestaurantOriginalData
    {
        ...
        protected override void ValidateSave()
        {
            ...
            if (InnerData.Uid is null)
                throw new PersistenceException(string.Format("Cannot save Restaurant with key '{0}' because the Uid cannot be null.", this.Uid?.ToString() ?? "<null>"));
        }
        ...
        public class RestaurantMembers
        {
            ...
            public EntityProperty Name { get; } = Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Entities["Restaurant"].Properties["Name"];
            public EntityProperty City { get; } = Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Entities["Restaurant"].Properties["City"];
            public EntityProperty Persons { get; } = Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Entities["Restaurant"].Properties["Persons"];
            #endregion
        ...
        sealed public override Entity GetEntity()
        {
            if (entity is null)
            {
                ...
                {
                    if (entity is null)
                        entity = Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Entities["Restaurant"];
                }
            }
            return entity;
        }
