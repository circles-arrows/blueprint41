...
public partial class ACTED_IN_REL : RELATIONSHIP, IFromIn_ACTED_IN_REL, IFromOut_ACTED_IN_REL    {
    ...
    public class ACTED_IN_ALIAS : AliasResult
    {
        ...
        internal ACTED_IN_ALIAS(ACTED_IN_REL parent)
        {
            ...
            CreationDate = new DateTimeResult(this, "CreationDate", Blueprint41.UnitTest.Multiple.Neo4j.DataStore.Neo4jModel.Model.Relations["ACTED_IN"], Blueprint41.UnitTest.Multiple.Neo4j.DataStore.Neo4jModel.Model.Relations["ACTED_IN"].Properties["CreationDate"]);
            roles = new StringListResult(this, "roles", Blueprint41.UnitTest.Multiple.Neo4j.DataStore.Neo4jModel.Model.Relations["ACTED_IN"], Blueprint41.UnitTest.Multiple.Neo4j.DataStore.Neo4jModel.Model.Relations["ACTED_IN"].Properties["roles"]);
        }
