        ...
        public override IReadOnlyDictionary<string, FieldResult> AliasFields
        {
            get
            {
                if (m_AliasFields is null)
                {
                    ...
                    {
                        { "Uid", new StringResult(this, "Uid", Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Entities["BaseEntity"], Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Entities["BaseEntity"].Properties["Uid"]) },
                        { "LastModifiedOn", new DateTimeResult(this, "LastModifiedOn", Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Entities["BaseEntity"], Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Entities["BaseEntity"].Properties["LastModifiedOn"]) },
                    };
                }
