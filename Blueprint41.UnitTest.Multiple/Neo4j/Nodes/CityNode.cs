        ...
        public override IReadOnlyDictionary<string, FieldResult> AliasFields
        {
            get
            {
                if (m_AliasFields is null)
                {
                    ...
                    {
                        { "Name", new StringResult(this, "Name", Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Entities["City"], Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Entities["City"].Properties["Name"]) },
                        { "State", new StringResult(this, "State", Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Entities["City"], Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Entities["City"].Properties["State"]) },
                        { "Country", new StringResult(this, "Country", Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Entities["City"], Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Entities["City"].Properties["Country"]) },
                        { "Uid", new StringResult(this, "Uid", Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Entities["City"], Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Entities["BaseEntity"].Properties["Uid"]) },
                        { "LastModifiedOn", new DateTimeResult(this, "LastModifiedOn", Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Entities["City"], Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Entities["BaseEntity"].Properties["LastModifiedOn"]) },
                    };
                }
