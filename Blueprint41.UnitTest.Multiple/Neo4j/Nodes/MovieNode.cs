        ...
        public override IReadOnlyDictionary<string, FieldResult> AliasFields
        {
            get
            {
                if (m_AliasFields is null)
                {
                    ...
                    {
                        { "Title", new StringResult(this, "Title", Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Entities["Movie"], Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Entities["Movie"].Properties["Title"]) },
                        { "Uid", new StringResult(this, "Uid", Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Entities["Movie"], Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Entities["BaseEntity"].Properties["Uid"]) },
                        { "LastModifiedOn", new DateTimeResult(this, "LastModifiedOn", Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Entities["Movie"], Blueprint41.UnitTest.Multiple.DataStore.MockModel.Model.Entities["BaseEntity"].Properties["LastModifiedOn"]) },
                    };
                }
