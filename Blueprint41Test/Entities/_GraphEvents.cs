...
namespace Datastore.Manipulation
{
	public static class GraphEvents
    {
		public static class Nodes
        {
            ...
            {
                private static readonly Entity Entity = Blueprint41Test.MovieModel.Model.Entities["Actor"];
            ...
            {
                private static readonly Entity Entity = Blueprint41Test.MovieModel.Model.Entities["Film"];
		...
		public static class Relationships
        {
            ...
            {
				private static readonly Relationship Relationship = Blueprint41Test.MovieModel.Model.Relations["PERSON_PRODUCED_FILM"];
            ...
            {
				private static readonly Relationship Relationship = Blueprint41Test.MovieModel.Model.Relations["PERSON_WROTE_FILM"];
