...
namespace Domain.Data.Query
{
	...
	public partial class Neo4jBaseNode : Blueprint41.Query.Node
	{
        ...
        public Neo4jBaseNode Where(JsNotation<string> Uid = default)
        {
        ...
        public Neo4jBaseNode Assign(JsNotation<string> Uid = default)
        {
            if (InlineConditions is not null || InlineAssignments is not null)
                throw new NotSupportedException("You cannot, at the same time, have inline-assignments and inline-conditions defined on a node.");
		...
		public SchemaBaseNode CastToSchemaBase()
		{
			...
			return new SchemaBaseNode(FromRelationship, Direction, NodeAlias, this.Neo4jLabel, this.Entity);
		}
		...
		public EmailAddressNode CastToEmailAddress()
		{
			...
			return new EmailAddressNode(FromRelationship, Direction, NodeAlias, this.Neo4jLabel, this.Entity);
		}
		...
		public PasswordNode CastToPassword()
		{
			...
			return new PasswordNode(FromRelationship, Direction, NodeAlias, this.Neo4jLabel, this.Entity);
		}
		...
		public PhoneNumberTypeNode CastToPhoneNumberType()
		{
			...
			return new PhoneNumberTypeNode(FromRelationship, Direction, NodeAlias, this.Neo4jLabel, this.Entity);
		}
