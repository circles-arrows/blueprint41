...
namespace Domain.Data.Manipulation
{
    ...
    public partial class Movie : OGM<Movie, Movie.MovieData, System.String>, IMovieOriginalData
    {
        ...
        #region Genres (Collection)

        public List<CONTAINS_GENRE> GenreRelations()
        {
            return CONTAINS_GENRE.Load(_queryGenreRelations.Value, ("key", Uid));
        }
        private readonly Lazy<ICompiled> _queryGenreRelations = new Lazy<ICompiled>(delegate()
        {
        ...
        public List<CONTAINS_GENRE> GenresWhere(Func<CONTAINS_GENRE.Alias, QueryCondition> expression)
        {
        ...
        public List<CONTAINS_GENRE> GenresWhere(JsNotation<System.DateTime?> CreationDate = default)
        {
            return GenresWhere(delegate(CONTAINS_GENRE.Alias alias)
            {
        ...
        public void AddGenre(Genre genre)
        {
            ...
            ((ILookupHelper<Genre>)InnerData.Genres).AddItem(genre, null, properties);
        }
        ...
        public List<DIRECTED> DirectorRelations()
        {
            return DIRECTED.Load(_queryDirectorRelations.Value, ("key", Uid));
        }
        private readonly Lazy<ICompiled> _queryDirectorRelations = new Lazy<ICompiled>(delegate()
        {
            return Transaction.CompiledQuery
        ...
        public List<DIRECTED> DirectorsWhere(Func<DIRECTED.Alias, QueryCondition> expression)
        {
            var query = Transaction.CompiledQuery
                .Match(node.Person.Alias(out var inAlias).In.DIRECTED.Alias(out var relAlias).Out.Movie.Alias(out var outAlias))
                .Where(outAlias.Uid == Uid)
        ...
        public List<DIRECTED> DirectorsWhere(JsNotation<System.DateTime?> CreationDate = default)
        {
            return DirectorsWhere(delegate(DIRECTED.Alias alias)
            {
                List<QueryCondition> conditions = new List<QueryCondition>();
        ...
        {
            Dictionary<string, object> properties = new Dictionary<string, object>();
            ((ILookupHelper<Person>)InnerData.Directors).AddItem(person, null, properties);
        }
        ...
        #region Producers (Collection)

        public List<PRODUCED> ProducerRelations()
        {
            return PRODUCED.Load(_queryProducerRelations.Value, ("key", Uid));
        }
        private readonly Lazy<ICompiled> _queryProducerRelations = new Lazy<ICompiled>(delegate()
        {
            return Transaction.CompiledQuery
        ...
        public List<PRODUCED> ProducersWhere(Func<PRODUCED.Alias, QueryCondition> expression)
        {
            var query = Transaction.CompiledQuery
                .Match(node.Person.Alias(out var inAlias).In.PRODUCED.Alias(out var relAlias).Out.Movie.Alias(out var outAlias))
                .Where(outAlias.Uid == Uid)
        ...
        public List<PRODUCED> ProducersWhere(JsNotation<System.DateTime?> CreationDate = default)
        {
            return ProducersWhere(delegate(PRODUCED.Alias alias)
            {
                List<QueryCondition> conditions = new List<QueryCondition>();
        ...
        {
            Dictionary<string, object> properties = new Dictionary<string, object>();
            ((ILookupHelper<Person>)InnerData.Producers).AddItem(person, null, properties);
        }
        ...
        #region Writers (Collection)

        public List<WROTE> WriterRelations()
        {
            return WROTE.Load(_queryWriterRelations.Value, ("key", Uid));
        }
        private readonly Lazy<ICompiled> _queryWriterRelations = new Lazy<ICompiled>(delegate()
        {
            return Transaction.CompiledQuery
        ...
        public List<WROTE> WritersWhere(Func<WROTE.Alias, QueryCondition> expression)
        {
            var query = Transaction.CompiledQuery
                .Match(node.Person.Alias(out var inAlias).In.WROTE.Alias(out var relAlias).Out.Movie.Alias(out var outAlias))
                .Where(outAlias.Uid == Uid)
        ...
        public List<WROTE> WritersWhere(JsNotation<System.DateTime?> CreationDate = default)
        {
            return WritersWhere(delegate(WROTE.Alias alias)
            {
                List<QueryCondition> conditions = new List<QueryCondition>();
        ...
        {
            Dictionary<string, object> properties = new Dictionary<string, object>();
            ((ILookupHelper<Person>)InnerData.Writers).AddItem(person, null, properties);
        }
