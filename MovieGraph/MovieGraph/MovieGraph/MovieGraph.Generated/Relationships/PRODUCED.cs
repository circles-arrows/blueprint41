...
public partial class PRODUCED_REL : RELATIONSHIP, IFromIn_PRODUCED_REL, IFromOut_PRODUCED_REL    {
    ...
    public class PRODUCED_ALIAS : AliasResult
    {
        ...
        internal PRODUCED_ALIAS(PRODUCED_REL parent)
        {
            ...
            CreationDate = new DateTimeResult(this, "CreationDate", MovieGraph.Model.Datastore.Model.Relations["PRODUCED"], MovieGraph.Model.Datastore.Model.Relations["PRODUCED"].Properties["CreationDate"]);
        }
