...
public partial class ACTED_IN_REL : RELATIONSHIP, IFromIn_ACTED_IN_REL, IFromOut_ACTED_IN_REL    {
    ...
    public class ACTED_IN_ALIAS : AliasResult
    {
        ...
        internal ACTED_IN_ALIAS(ACTED_IN_REL parent)
        {
            ...
            CreationDate = new DateTimeResult(this, "CreationDate", MovieGraph.Model.Datastore.Model.Relations["ACTED_IN"], MovieGraph.Model.Datastore.Model.Relations["ACTED_IN"].Properties["CreationDate"]);
        }
