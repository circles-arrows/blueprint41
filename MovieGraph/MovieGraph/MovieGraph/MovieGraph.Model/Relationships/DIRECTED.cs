...
public partial class DIRECTED_REL : RELATIONSHIP, IFromIn_DIRECTED_REL, IFromOut_DIRECTED_REL    {
        ...
        public new DIRECTED_REL Repeat(int minHops, int maxHops)
        {
    ...
    public class DIRECTED_ALIAS : AliasResult
    {
        ...
        internal DIRECTED_ALIAS(DIRECTED_REL parent)
        {
            ...
            CreationDate = new DateTimeResult(this, "CreationDate", MovieGraph.Model.Datastore.Model.Relations["DIRECTED"], MovieGraph.Model.Datastore.Model.Relations["DIRECTED"].Properties["CreationDate"]);
        }
