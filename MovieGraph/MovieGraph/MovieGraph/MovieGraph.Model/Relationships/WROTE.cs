...
public partial class WROTE_REL : RELATIONSHIP, IFromIn_WROTE_REL, IFromOut_WROTE_REL    {
    ...
    public class WROTE_ALIAS : AliasResult
    {
        ...
        internal WROTE_ALIAS(WROTE_REL parent)
        {
            ...
            CreationDate = new DateTimeResult(this, "CreationDate", MovieGraph.Model.Datastore.Model.Relations["WROTE"], MovieGraph.Model.Datastore.Model.Relations["WROTE"].Properties["CreationDate"]);
        }
