...
namespace Blueprint41.Core
{
    public abstract class Data
    {
        ...
        protected Dictionary<string, PropertyDetail> PropertyDetails
        {
            get
            {
                PersistenceProvider factory = Transaction.RunningTransaction.PersistenceProvider;
        ...
        protected class PropertyDetail
        {
            internal PropertyDetail(IEnumerable<TypeMapping> supportedTypeMappings, PropertyInfo info)
            {
                ...
                Mapping = supportedTypeMappings.FirstOrDefault(item => item.ReturnType == info.PropertyType) ?? throw new InvalidOperationException();
