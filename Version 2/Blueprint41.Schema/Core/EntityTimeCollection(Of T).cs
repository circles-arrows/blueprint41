...
namespace Blueprint41.Core
{
    ...
    {
        public EntityTimeCollection(OGM parent, Property property, EntityFlavor flavor, Action<TEntity>? eagerLoadLogic = null) : base(parent, property, flavor, eagerLoadLogic) { }
