...
namespace Blueprint41.Core
{
    public interface IEntityAdvancedFeatures
    {
        ...
        OGM Activator(EntityFlavor flavor, EventOptions eventOptions = EventOptions.GraphEvents);
        ...
        /// <returns>The new node</returns>
        OGM? Map(driver.NodeResult node, NodeMapping mappingMode, EntityFlavor flavor);
        ...
        /// <param name="mappingMode">The node mapping mode</param>
        /// <returns>The new node</returns>
        OGM? Map(driver.NodeResult node, string cypher, Dictionary<string, object?>? parameters, NodeMapping mappingMode, EntityFlavor flavor);
