...
namespace Blueprint41.Refactoring.Schema
{
    public class SchemaInfo_Neo4jV4 : SchemaInfo
    {
        ...
        protected override ConstraintInfo   NewConstraintInfo(IReadOnlyDictionary<string, object> rawRecord, PersistenceProvider persistenceProvider)   => new ConstraintInfo(rawRecord, persistenceProvider);
        protected override IndexInfo        NewIndexInfo(IReadOnlyDictionary<string, object> rawRecord, PersistenceProvider persistenceProvider)        => new IndexInfo_Neo4jV4(rawRecord, persistenceProvider);
